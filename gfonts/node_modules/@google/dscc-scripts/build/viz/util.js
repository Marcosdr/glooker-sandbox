...
exports.validateBuildValues = (args) => {
    ...
    const devBucket = "gs://gfonts-viz/dev" // process.env.npm_package_dsccViz_gcsDevBucket;
    if (devBucket === undefined) {
        throw util_1.invalidVizConfig('gcsDevBucket');
    }
    const prodBucket = "gs://gfonts-viz/prod" // process.env.npm_package_dsccViz_gcsProdBucket;
